...
# Currently available SKG-IF compliant endpoints


| Organization | Catalogue exposed | SKG-IF API | Git |
| ----- | ----- | ----- | ----- |
| OpenCitations | [OpenCitations Datasets](https://search.opencitations.net/) | [API Staging](https://api-stg.opencitations.net/skg-if/) |  |
...
| [OPERAS](https://operas-eu.org/) | [GoTriple](https://gotriple.eu/) | [API Prod](https://api.gotriple.eu/api/skg-if/) | |
